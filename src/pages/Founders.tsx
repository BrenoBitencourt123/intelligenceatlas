          ...
          <AnimatePresence>
            {revealed && (
              ...
              >
                ...
                <section className="space-y-6">
                  <motion.div
                    className="rounded-2xl border-2 p-6 sm:p-8 space-y-6 bg-card"
                  ...
                  >
                    ...
                    <div className="text-center space-y-2">
                      <p className="text-3xl sm:text-4xl font-extrabold" style={{ color: AMBER }}>
                        {VAGAS_RESTANTES}/{VAGAS_TOTAL}
                      </p>
                      <p className="text-sm text-muted-foreground">vagas restantes</p>
                      <div className="max-w-xs mx-auto h-2 rounded-full bg-secondary overflow-hidden">
                        <div
                    ...
                    <Button
                      size="lg"
                      className="w-full h-14 text-lg font-bold rounded-2xl text-white shadow-lg hover:shadow-xl transition-all hover:brightness-110 active:scale-[0.98] border-0"
                      style={{ background: AMBER }}
