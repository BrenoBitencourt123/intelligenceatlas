...
const SCHEDULE: Record<number, DaySchedule> = {
  1: { area: 'matematica', sessionType: 'objetivas', questionCount: 45, label: 'Matemática', dayName: 'Segunda' },
  2: { area: 'linguagens', sessionType: 'objetivas', questionCount: 45, label: 'Linguagens', dayName: 'Terça' },
  3: { area: 'natureza', sessionType: 'objetivas', questionCount: 45, label: 'Ciências da Natureza', dayName: 'Quarta' },
  4: { area: 'humanas', sessionType: 'objetivas', questionCount: 45, label: 'Ciências Humanas', dayName: 'Quinta' },
