...
<title>Guia da vaga em {c['nome']} — UFU 2026/2 | Placar UFU</title>
{FONT_LINK}</head><body><style>{CSS}</style>
<p class="tag"><a href="https://inteligenciatlas.com/ufu/">Placar UFU</a> · guia da vaga</p>
<h1>Guia da vaga em {c['nome']}</h1>
...
A sua meta não é essa: é <b>{mt} acertos</b> — o corte mais uma margem de segurança.</div>

<div class="box warn"><b>Por que mirar acima do corte?</b> Pra cada vaga, até <b>6 candidatos</b>
passam pra 2ª fase. Passar no corte só te coloca na disputa da redação (peso 3, 80 pontos),
contra outros 5 por vaga. Quem entra raspando precisa de uma redação quase perfeita;
quem entra com sobra transforma a redação em vantagem, não em salvação.</div>

<h2>Corte e meta por modalidade</h2>
<table><tr><th>Modalidade</th><th class="r">Corte 2026/2</th><th class="r">Meta segura</th></tr>{cotas_rows}</table>
...
fora do corte, zona de risco (passa na 1ª fase e perde a vaga) ou zona segura.<br><br>
...
<b>4. Segurança de verdade.</b> Estar seguro é a <i>média dos simulados menos a variação</i>
ficar acima de {mt}. 45/38/47 não é segurança — é sorte intermitente. Simule a prova completa
(65 questões, 5h30).</div>

<a class="cta" href="https://inteligenciatlas.com/redacao-ufu">Corrigir minha redação grátis — 1ª correção por nossa conta</a>
<a class="cta sec" href="https://inteligenciatlas.com/calculadora-ufu">Calcular minha nota completa (pesos + redação)</a>
